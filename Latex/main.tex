...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Estas métricas, presentadas en Grafana \autoref{sec:visualizacion}, permitieron correlacionar rendimiento técnico y experiencia de usuario.
    \end{itemize}
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[width=0.8\linewidth]{errores.png}
            \caption{Enter Caption}
            \label{fig:enter-label}
        \end{figure}
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.7\linewidth]{datos10.png}
...
\begin{itemize}
    ...
    Como se puede observar en los datos recogidos anteriormente, el percentil 95 presenta casi siempre un valor cercano a los 2000ms. Esto se debe al endpoint de checkout, el cual incluye un retraso de 2 segundos, según las especificaciones de la práctica, con el objetivo de simular una transacción real. Este comportamiento nos dice por qué dicho endpoint es tan crítico y cómo su tiempo de respuesta afecta directamente al valor del percentil 95, impactando negativamente en la eficiencia general de la web.
...
La Ley de Little establece que el número medio de trabajos en un sistema en equilibrio es igual al producto de la tasa media de llegadas y el tiempo medio de permanencia en el sistema:
...
\begin{tabular}{|c|c|c|c|}
\hline
\textbf{Tiempo (min)} & \textbf{Usuarios \(N\)} & \textbf{Throughput \(\mu\)} & \textbf{\(\mu \cdot R\) (estimado)} \\
\hline
5  & 41  & 16.8  & 2.25 \\
10 & 81  & 35.6  & 4.71 \\
15 & 121 & 52.8  & 7.37 \\
...
\begin{itemize}
    \item Número de usurios registrados: Permite conocer el número de usuarios en tiempo resgistrados.
    \item Pedidos creados: Refleja el número de transacciones. 
    \item Ingresoso totales: Refleja el rendimiento económico.
    \item Numero de carritos que tienen itmes/productos dentro: Permite conocer los usaurios que podrían estar listo para realizar un pedido.
    \item Top 10 productos más vendidos: Permite evaluar como de eficaz y atractiva es la web y los productso que se venden.
\end{itemize}
