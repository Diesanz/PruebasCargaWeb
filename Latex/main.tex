...
\section{Introducción Flask}
    ...
    \subsection{Entorno virtual}
        ...
        Con el entorno virtual activado, habría que instalar el paquete de Flask con el comando \lstinline{pip install flask}, y comprobarlo con \lstinline{pip show flask}, además de instalar otros paquetes encontrados en el fichero \textbf{requirements.txt} de nuestra carpeta d la práctica.
