...
\section{Flask}
    ...
    \subsection{Contenido de las carpetas}
        La carpeta db está formada por:
            \begin{itemize}
            ...
            \end{itemize}
        La carpeta models está formada por:
            \begin{itemize}
            ...
            \end{itemize}
        La carpeta routes está formada por:
            \begin{itemize}
                ...
                \item productosController.py $\rightarrow$ es el controlador de los productos en venta, es el encargado de mostrar la lista de productos junto con una breve información.
            ...
            \end{itemize}
        La carpeta schemas está formada por:
            \begin{itemize}
            ...
            \end{itemize}
        La carpeta static está formada por:
            \begin{itemize}
            ...
            \end{itemize}
        La carpeta templates está formada por:
            \begin{itemize}
            ...
            \end{itemize}
        La carpeta utils está formada por:
            \begin{itemize}
